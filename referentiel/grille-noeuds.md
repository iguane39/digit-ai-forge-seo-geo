...
| 85 | Leads Entrants | CADRAGE | Quelle cible de leads organiques ? | cadrage + nœuds 72 et 46 | appliquer le taux de conversion observé au trafic cible ; **si le taux n'est pas mesuré, la cible est non calculable et doit être déclarée telle** | cible chiffrée ou déclaration explicite de non-calculabilité | `CA` |
| 86 | Ventes | CADRAGE | Quelle cible de chiffre d'affaires organique ? | cadrage + nœuds 8 et 73 | appliquer la valeur client aux leads cibles | cible chiffrée ou déclaration explicite de non-calculabilité | `CA` |
